...
form_class = uic.loadUiType(r"C:\Users\crebi\Documents\GitHub\PyQt5\Designer\16_Notepad_ReverseSearch\notepad.ui")[0]

class FindWindow(QDialog):
    def __init__(self, parent):
        super(FindWindow, self).__init__(parent)
        uic.loadUi(r"C:\Users\crebi\Documents\GitHub\PyQt5\Designer\16_Notepad_ReverseSearch\find.ui", self)
        self.show()
    ...
    def updown_radio_button(self):
        if self.radioButton_down.isChecked():
            self.up_down = False # "down"
            # print(self.up_down)
        elif self.radioButton_up.isChecked():
            self.up_down = True # "up"
            # print(self.up_down)
