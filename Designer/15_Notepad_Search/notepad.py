...
form_class = uic.loadUiType(r"C:\Users\crebi\Documents\GitHub\PyQt5\Designer\15_Notepad_Search\notepad.ui")[0]

class FindWindow(QDialog):
    def __init__(self, parent):
        super(FindWindow, self).__init__(parent)
        uic.loadUi(r"C:\Users\crebi\Documents\GitHub\PyQt5\Designer\15_Notepad_Search\find.ui", self)
        self.show()
